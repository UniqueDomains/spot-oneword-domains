# Available .SPOT One-Word Domains (5,622,028)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C860%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C028%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,860-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,028 domains** on the canonical page below.

**Public extract:** 9,860 rows · **Live catalog:** 5,622,028 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/spot?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_spot_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/spot?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_spot_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./spot.csv">CSV</a> / <a href="./spot.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_spot_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_spot_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .SPOT search](https://unique.domains/domains/tld/spot?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_spot_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .SPOT search](https://unique.domains/domains/tld/spot?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_spot_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./spot.csv) or [Download JSON](./spot.json)
...
| ----------------------- | ------------------------------------------------ |
| 9,860-row public sample | 5,622,028 live domains                           |
...
| robotic.spot    | resell    | —         | —             | 72             | 32     | 7      | Dynadot, LLC          |
...
> Unique Domains. *Available .SPOT One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
